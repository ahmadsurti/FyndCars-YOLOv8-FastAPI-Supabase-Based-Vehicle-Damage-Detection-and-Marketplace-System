  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'fixed z-50 flex flex-col gap-4 bg-[#08090c] text-foreground border-white/[0.08] shadow-2xl transition ease-in-out data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:animate-in data-[state=open]:duration-500',
          side === 'right' &&
      ...
      >
        {children}
        <SheetPrimitive.Close className='absolute right-4 top-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:outline-hidden cursor-pointer'>
          <X className='size-4' />
